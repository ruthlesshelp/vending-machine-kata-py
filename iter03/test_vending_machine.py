...
def test_select_cola_with_payment_3_quarters_expect_nothing_is_dispensed():
    # Arrange
    expected = { }
    class_under_test = VendingMachine()
...
def test_display_when_3q_and_select_cola_expect_display_shows_price_1_pt_00():
    # Arrange
    expected = 'PRICE $1.00'
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.QUARTER, 3)
...
def test_current_amount_when_payment_3q_select_cola_and_check_display_expect_current_amount_shows_0_pt_75():
    # Arrange
    expected = '$0.75'
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.QUARTER, 3)
...
def test_select_chips_when_payment_3n_and_select_chips_expect_no_chips_dispensed():
    # Arrange
    expected = {}
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.NICKEL, 3)
...
def test_display_when_payment_3n_and_select_chips_expect_display_not_thank_you():
    # Arrange
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.NICKEL, 3)
    class_under_test.select_chips()
...
def test_display_when_payment_2q_1d_1n_and_select_candy_expect_1_candy_dispensed():
    # Arrange
    expected = { 'candy': 1 }
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.QUARTER, 2)
...
def test_display_when_payment_2q_1d_1n_and_select_candy_expect_display_shows_thank_you():
    # Arrange
    expected = 'THANK YOU'
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.QUARTER, 2)
...
def test_select_candy_when_payment_1q_1d_expect_no_candy_dispensed():
    # Arrange
    expected = {}
    class_under_test = VendingMachine()
    class_under_test.insert_coins(Coin.QUARTER, 1)
...
def test_display_when_payment_3d_and_select_chips_expect_display_is_price_0_pt_50():
    # Arrange
    expected = "PRICE $0.50"
    class_under_test = VendingMachine()
